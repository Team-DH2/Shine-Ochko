    ...
    >
      <div className="p-8 text-white min-w-80">
        ...
        <p className="text-center text-neutral-400 mb-8">
          {isLoginView
            ? "Нэвтрэж ороод хүссэн танхимаа захиалаарай."
            : "Бүртгүүлээд хүссэн танхимаа захиалаарай."}
        </p>
        ...
        <div className="text-center mt-6">
          ...
          >
            {isLoginView
              ? "Аккоунт бүртгүүлээгүй байна уу? Бүртгүүлэх"
              : "Аль хэдийн бүртгүүлсэн байна уу? Нэвтрэх"}
          </button>
        </div>
      </div>
    </div>
