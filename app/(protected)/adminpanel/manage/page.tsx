  ...
  return (
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
      {form.map((item, index) => (
        <Card
          key={item.id}
          className="group bg-gradient-to-br from-neutral-900 to-neutral-800 border border-neutral-700 hover:border-blue-500/50 shadow-xl hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 hover:scale-[1.03] text-white rounded-2xl overflow-hidden flex flex-col"
          ...
          <CardContent className="p-6 flex flex-col flex-1">
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                ...
                <h2 className="text-3xl font-bold mb-1 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                  {item.hallname}
                </h2>
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-auto pt-4 border-t border-neutral-700">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 py-3 rounded-xl text-base font-semibold transition-all duration-200 shadow-lg hover:shadow-green-500/50 flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 px-5 py-3 rounded-xl text-base font-semibold transition-all duration-200 shadow-lg hover:shadow-red-500/50 flex items-center justify-center gap-2"
              >
                <X className="w-5 h-5" />
                Татгалзах
              </button>
